...
export class ContatosListComponent implements OnInit {
	 ...
	 */
	constructor(private contatoService: ContatosService, private dialogService: DaialogService, private router: Router) { }
	...
	verDetalhe(contato: Contatos): void {
		console.log('Visualizar');
		let link = ['contato/visualizar', contato.id];
